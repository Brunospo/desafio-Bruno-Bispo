...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ...
        ['combo2 + chantily', 'dinheiro', 'Item extra não pode ser pedido sem o principal', ['chantily,1', 'combo2,1']],
        ['combo1 + queijo', 'credito', 'Item extra não pode ser pedido sem o principal', ['queijo,1', 'combo1,1']],
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
